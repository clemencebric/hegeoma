...
function Services() {
    ...
    const serviceDetails = [
        {
            title: "Integration",
            description: "Hegeoma prépare, installe et déploie vos Mac, iPhone ou iPad...",
            backgroundImage: integrationImage
        },
        {
            title: "Support",
            description: "Hegeoma peut prendre en charge le support de tout ou partie de votre parc informatique...",
            backgroundImage: supportImage
        },
        {
            title: "Formation",
            description: "Vous cherchez une formation sur mesure, matérielle (Mac, iPhone, iPad)...",
            backgroundImage: formationImage
        },
        {
            title: "Mobilité et gestion de flotte",
            description: "Vous désirez gérer et déployer plus facilement votre flotte d’appareils avec un MDM ?...",
            backgroundImage: mobiliteImage
        },
        {
            title: "Maintenance",
            description: "Vous souhaitez que quelqu’un vous conseille, assure la bonne évolution matérielle et logicielle...",
            backgroundImage: maintenanceImage
        },
        {
            title: "Audit et conseil",
            description: "Vous désirez un conseil indépendant ? Un audit indépendant effectué par un professionnel certifié Apple...",
